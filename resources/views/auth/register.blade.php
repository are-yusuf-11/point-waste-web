        ...
        <section class="w-full lg:w-1/2 flex items-center justify-center p-md lg:p-xl bg-surface relative">
            <div class="w-full max-w-[440px]" id="auth-canvas">
                ...
                <div class="flex bg-secondary-container rounded-lg p-xs mb-lg">
                    <a href="{{ Route::has('showLogin') ? route('showLogin') : '#' }}" class="flex-1 py-sm text-center font-label-md text-label-md rounded-md transition-all text-on-secondary-container hover:text-primary">
                        Login
                    </a>
                    <a href="{{ Route::has('showRegister') ? route('showRegister') : '#' }}" class="flex-1 py-sm text-center font-label-md text-label-md rounded-md transition-all bg-surface-container-lowest text-primary font-bold shadow-sm">
                        Register
                    </a>
                </div>
