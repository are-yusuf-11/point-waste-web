    ...
    <aside class="w-[260px] bg-surface border border-gray-100 flex flex-col justify-between p-6 h-[calc(100vh-2rem)] sticky top-4 z-30 rounded-2xl shadow-sm">
        <div class="space-y-10">
            ...
            <nav class="space-y-1">
                ...
                <a href="/mutasi-poin-test" class="flex items-center gap-4 px-4 py-3 text-on-surface-variant hover:bg-gray-50 hover:text-on-surface rounded-xl transition-all">
        ...
        <div class="border-t border-gray-100 pt-5 space-y-4">
            <div class="flex items-center gap-3 px-1">
                ...
                <div>
                    ...
                    <span class="text-xs text-gray-400">Warga RT 04</span>
                </div>
            </div>
        ...
        <main class="flex-1 px-6 pb-12">
            <form action="#" method="POST" class="space-y-6">
                ...
                <section class="bg-surface rounded-2xl border border-gray-100 shadow-sm p-6 flex items-center gap-6">
                    <div class="relative">
                        <div class="w-24 h-24 bg-gray-200 rounded-full overflow-hidden border border-gray-300">
                            <div class="w-full h-full bg-[#cbd5e1] flex items-center justify-center text-gray-400">
                                <span class="material-symbols-outlined text-[56px] icon-unfilled">account_circle</span>
                            </div>
                        </div>
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-[#0f2942]">{{ Auth::user()->name ?? 'Arafly ramdani' }}</h2>
                        <p class="text-sm text-gray-500 mt-1">Warga • Bergabung Juni 2026</p>
                ...
                <section class="bg-surface rounded-2xl border border-gray-100 shadow-sm p-6 space-y-6">
                    ...
                    <div class="space-y-4">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="name" value="{{ Auth::user()->name ?? 'Arafly ramdani' }}" class="w-full px-4 py-3 bg-[#f0f4f9] border-none rounded-xl text-sm text-[#0f2942] focus:ring-2 focus:ring-emerald-600 font-medium">
                        </div>

                        <div class="space-y-2">
                            <label class="text-xs font-semibold text-gray-600 block">Nomor HP</label>
                            <input type="text" name="phone" value="{{ $phone ?? '0812-3456-7890' }}" class="w-full px-4 py-3 bg-[#f0f4f9] border-none rounded-xl text-sm text-[#0f2942] focus:ring-2 focus:ring-emerald-600 font-medium">
                        </div>

                        <div class="space-y-2">
                            <label class="text-xs font-semibold text-gray-600 block">Alamat Lengkap</label>
                            <textarea name="alamat" rows="3" class="w-full px-4 py-3 bg-[#f0f4f9] border-none rounded-xl text-sm text-[#0f2942] focus:ring-2 focus:ring-emerald-600 font-medium resize-none">Jl. Hijau Lestari No. 42, RT 04/RW 02, Kelurahan Eco City</textarea>
                        </div>
                    </div>
                </section>
                ...
                <section class="bg-surface rounded-2xl border border-gray-100 shadow-sm p-6 space-y-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center justify-between bg-[#f0f4f9] p-4 rounded-xl">
                            <div>
                                <span class="text-[11px] font-semibold text-gray-400 block tracking-wide uppercase">Email</span>
                                <span class="text-sm font-medium text-[#0f2942]">{{ Auth::user()->email ?? 'Arafly ramdani@email.com' }}</span>
                            </div>
                            <button type="button" class="text-xs font-bold text-primary hover:underline">Ubah Email</button>
                        </div>

                        <div class="flex items-center justify-between bg-[#f0f4f9] p-4 rounded-xl">
                            <div>
                                <span class="text-[11px] font-semibold text-gray-400 block tracking-wide uppercase">Kata Sandi</span>
                                <span class="text-sm font-medium text-[#0f2942] tracking-widest">•••••••••••••</span>
                            </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="/dashboard-warga-test" class="px-6 py-3.5 border border-gray-200 bg-white hover:bg-gray-50 text-gray-700 font-bold rounded-xl text-sm transition">
                        Batal
                    </a>
                </div>
            </form>
        ...
        <div class="bg-white w-full max-w-[400px] rounded-3xl shadow-xl overflow-hidden flex flex-col" @click.away="modalFoto = false">
            ...
            <div class="p-8 flex flex-col items-center justify-center bg-white">
                <div class="w-48 h-48 rounded-full border-2 border-primary bg-gray-100 flex items-center justify-center overflow-hidden mb-6 relative">
                    <div class="w-full h-full bg-[#cbd5e1] flex items-center justify-center text-gray-400">
                        <span class="material-symbols-outlined text-[110px] icon-unfilled">account_circle</span>
                    </div>
                </div>
                ...
                <div class="flex items-center bg-gray-50 rounded-2xl px-4 py-2 border border-gray-100 divide-x divide-gray-200 gap-4 mb-8 text-sm text-gray-600">
                    <button type="button" class="flex items-center gap-1.5 hover:text-primary transition pr-1">
                        <span class="material-symbols-outlined text-[18px] icon-unfilled">rotate_right</span>
                        Rotate
                    </button>
                    <button type="button" class="flex items-center gap-1.5 hover:text-primary transition pl-4">
                ...
                <div class="w-full space-y-3">
                    <button type="button" class="w-full py-3 bg-primary hover:bg-emerald-900 text-white font-semibold rounded-xl text-sm flex items-center justify-center gap-2 transition">
                        <span class="material-symbols-outlined text-[20px]">upload</span>
                        Unggah Foto Baru
                    </button>
                    <button type="button" class="w-full py-3 bg-white border border-gray-200 hover:bg-red-50 text-red-600 font-semibold rounded-xl text-sm flex items-center justify-center gap-2 transition">
            ...
            <div class="bg-gray-50 px-6 py-4 flex items-center justify-end gap-3 border-t border-gray-100">
                ...
                <button type="button" class="px-6 py-2 bg-primary hover:bg-emerald-900 text-white text-sm font-semibold rounded-lg transition">
                    Simpan
                </button>
            </div>
        </div>
        ...
        <div class="bg-white w-full max-w-[460px] rounded-3xl shadow-xl overflow-hidden flex flex-col" @click.away="modalSandi = false">
            ...
            <div class="p-6 space-y-5">
                ...
                <div class="space-y-2 relative" x-data="{ show: false }">
                    ...
                    <input :type="show ? 'text' : 'password'" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-emerald-600 focus:border-emerald-600 placeholder-gray-300 pr-10" placeholder="Masukan kata sandi">
                ...
                <div class="space-y-2 relative" x-data="{ show: false }">
                    ...
                    <input :type="show ? 'text' : 'password'" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-emerald-600 focus:border-emerald-600 placeholder-gray-300 pr-10" placeholder="Masukan kata sandi baru">
                    <button type="button" @click="show = !show" class="absolute bottom-3 right-3 text-gray-400 hover:text-gray-600 flex items-center">
                        <span class="material-symbols-outlined text-[20px]" x-text="show ? 'visibility_off' : 'visibility'"></span>
                    </button>
                </div>
                ...
                <div class="space-y-2 relative" x-data="{ show: false }">
                    ...
                    <input :type="show ? 'text' : 'password'" class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-emerald-600 focus:border-emerald-600 placeholder-gray-300 pr-10" placeholder="Ulangi kata sandi baru">
                    <button type="button" @click="show = !show" class="absolute bottom-3 right-3 text-gray-400 hover:text-gray-600 flex items-center">
                        <span class="material-symbols-outlined text-[20px]" x-text="show ? 'visibility_off' : 'visibility'"></span>
                    </button>
                </div>
            ...
            <div class="bg-gray-50 px-6 py-4 flex items-center justify-end gap-3 border-t border-gray-100">
                ...
                <button type="button" class="px-5 py-2 bg-primary hover:bg-emerald-900 text-white font-bold rounded-xl text-xs transition shadow-sm">
                    Simpan Perubahan
                </button>
            </div>
        </div>
